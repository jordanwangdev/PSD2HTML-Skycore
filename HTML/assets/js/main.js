...
$(document).ready(function () {
  "use strict";
  var $dashWrap = $(".left-sidebar");
  var $sidebarToggle = $dashWrap.find(".menu-toggle");
  var $sidebarLeft = $dashWrap.find(".menubar");
  var $sidebarLeftSecondary = $dashWrap.find(".menubar-secondary");
  var $sideNavItem = $dashWrap.find(".nav-item");
 ...
 // Prevent opeing link if has data-item
  ...
  $sidebarToggle.on("click", function (event) {
    $dashWrap.toggleClass("sidenav-open");
  });
  $('.sidebar-close').on('click', function (e) {
    $dashWrap.removeClass("sidenav-open");
  });
